...
class processstruct_arrayamns_processTypeObj(KeepInOrder):
	'''
...
class reactantstruct_arrayreacprodTypeObj(KeepInOrder):
	'''
...
class constituentsstruct_arrayamns_constituentTypeObj(KeepInOrder):
	'''
...
class rolestructureidentifier(KeepInOrder):
	'''
...
class productstruct_arrayreacprodTypeObj(KeepInOrder):
	'''
...
class qualitystructureidentifier(KeepInOrder):
	'''
...
class tablesstruct_arraytablesObj(KeepInOrder):
	'''
...
class tablestruct_arraytableObj(KeepInOrder):
	'''
...
class tables_coordstruct_arraytables_coordObj(KeepInOrder):
	'''
...
class coordsstruct_arraycoordsObj(KeepInOrder):
	'''
...
class version_indstruct_arrayversion_indObj(KeepInOrder):
	'''
...
class data_releasestruct_arraydata_releaseObj(KeepInOrder):
	'''
