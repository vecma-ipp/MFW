...
class wall0dstructurewall_wall0d(KeepInOrder):
	'''
...
class plasmastructurewall_wall0d_plasma(KeepInOrder):
	'''
...
class wall2d_mhdstructurewall2d_mhd(KeepInOrder):
	'''
...
class res_wallstruct_arraymhd_res_wall2dObj(KeepInOrder):
	'''
...
class walltypestructureidentifier(KeepInOrder):
	'''
...
class holesstructureholes(KeepInOrder):
	'''
...
class coordinatesstructurecoordinates(KeepInOrder):
	'''
...
class widthstructurewidth(KeepInOrder):
	'''
...
class ideal_wallstructuremhd_ideal_wall2d(KeepInOrder):
	'''
...
class wall2dstruct_arraywall2dObj(KeepInOrder):
	'''
...
class wall_idstructureidentifier(KeepInOrder):
	'''
...
class limiterstructurewall_limiter(KeepInOrder):
	'''
...
class limiter_idstructureidentifier(KeepInOrder):
	'''
...
class limiter_unitstruct_arraylimiter_unitObj(KeepInOrder):
	'''
...
class vesselstructurewall_vessel(KeepInOrder):
	'''
...
class vessel_idstructureidentifier(KeepInOrder):
	'''
...
class vessel_unitstruct_arraywall_vessel_unitObj(KeepInOrder):
	'''
...
class annularstructurewall_vessel_annular(KeepInOrder):
	'''
...
class insidestructurerz1D(KeepInOrder):
	'''
...
class outsidestructurerz1D(KeepInOrder):
	'''
...
class blocksstructurewall_blocks(KeepInOrder):
	'''
...
class blocks_unitstruct_arraywall_blocks_unitObj(KeepInOrder):
	'''
...
class radial_buildstructurewall_wall2d_vessel_radial_build(KeepInOrder):
	'''
...
class plasmastruct_arrayplasmaComplexTypeObj(KeepInOrder):
	'''
...
class wall_statestruct_arraywall_unitsComplexTypeObj(KeepInOrder):
	'''
...
class layersstruct_arraywall_unitsComplexType_layersObj(KeepInOrder):
	'''
...
class trap_typestruct_arraytrap_typeObj(KeepInOrder):
	'''
...
class trap_idstructureidentifier(KeepInOrder):
	'''
...
class etastructurecomplexgrid_scalar(KeepInOrder):
	'''
...
class permeabilitystructurecomplexgrid_scalar(KeepInOrder):
	'''
...
class jstructurecomplexgrid_vector(KeepInOrder):
	'''
...
class wall3dstruct_arraywall3dObj(KeepInOrder):
	'''
...
class wall_typesstruct_arraywall_typesObj(KeepInOrder):
	'''
...
class layersstruct_arraywall_types_layersObj(KeepInOrder):
	'''
...
class compoundsstruct_arraycompound_descObj(KeepInOrder):
	'''
...
class elementsstruct_arrayelement_descObj(KeepInOrder):
	'''
