...
class nstruct_arraymhd_modeObj(KeepInOrder):
	'''
...
class plasmastructuremhd_plasma(KeepInOrder):
	'''
...
class a_pertstructuremhd_vector(KeepInOrder):
	'''
...
class b_pertstructuremhd_vector(KeepInOrder):
	'''
...
class v_pertstructuremhd_vector(KeepInOrder):
	'''
...
class vacuumstructuremhd_vacuum(KeepInOrder):
	'''
