...
class modestruct_arrayntm_modeObj(KeepInOrder):
	'''
...
class onsetstructurentm_mode_onset(KeepInOrder):
	'''
...
class full_evolstructurentm_mode_full_evol(KeepInOrder):
	'''
...
class islandstructurentm_mode_full_evol_island(KeepInOrder):
	'''
...
class evolutionstructurentm_mode_evolution(KeepInOrder):
	'''
...
class islandstructurentm_mode_evolution_island(KeepInOrder):
	'''
