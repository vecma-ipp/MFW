...
class desc_ironstructuredesc_iron(KeepInOrder):
	'''
...
class permeabilitystructurepermeability(KeepInOrder):
	'''
...
class geom_ironstructuregeom_iron(KeepInOrder):
	'''
...
class magnetisestructuremagnetise(KeepInOrder):
	'''
...
class mrstructureexp1D(KeepInOrder):
	'''
...
class mzstructureexp1D(KeepInOrder):
	'''
