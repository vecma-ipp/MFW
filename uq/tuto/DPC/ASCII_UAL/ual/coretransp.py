...
class valuesstruct_arraycoretransp_valuesObj(KeepInOrder):
	'''
...
class transportidstructureidentifier(KeepInOrder):
	'''
...
class ni_transpstructureni_transp(KeepInOrder):
	'''
...
class ne_transpstructurene_transp(KeepInOrder):
	'''
...
class nz_transpstruct_arraytranscoefimpObj(KeepInOrder):
	'''
...
class ti_transpstructuretranscoefion(KeepInOrder):
	'''
...
class te_transpstructuretranscoefel(KeepInOrder):
	'''
...
class tz_transpstruct_arraytranscoefimpObj(KeepInOrder):
	'''
...
class vtor_transpstructuretranscoefvtor(KeepInOrder):
	'''
