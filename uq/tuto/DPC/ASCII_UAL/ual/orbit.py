...
class comstructurecom(KeepInOrder):
	'''
...
class tracestructuretrace(KeepInOrder):
	'''
...
class global_paramstructureorbit_global_param(KeepInOrder):
	'''
...
class special_posstructureorbit_special_pos(KeepInOrder):
	'''
...
class midplanestructureorbit_midplane(KeepInOrder):
	'''
...
class outerstructureorbit_pos(KeepInOrder):
	'''
...
class innerstructureorbit_pos(KeepInOrder):
	'''
...
class turning_ptsstructureorbit_turning_pts(KeepInOrder):
	'''
...
class upperstructureorbit_pos(KeepInOrder):
	'''
...
class lowerstructureorbit_pos(KeepInOrder):
	'''
