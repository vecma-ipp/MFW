...
class refl_receivestruct_arrayrefl_receiveObj(KeepInOrder):
	'''
...
class raw_signalstructuret_series_real(KeepInOrder):
	'''
...
class io_signalstructuret_series_real(KeepInOrder):
	'''
...
class iq_receiverstructuret_series_cplx(KeepInOrder):
	'''
...
class antennasstruct_arrayreflectometry_antennasObj(KeepInOrder):
	'''
...
class originstructureorigin(KeepInOrder):
	'''
...
class refposstructurerzphi0D(KeepInOrder):
	'''
...
class radfieldstructurereflectometry_radfield(KeepInOrder):
	'''
...
class gaussianstruct_arrayreflectometry_radfield_gaussianObj(KeepInOrder):
	'''
...
class aperturestructuresimp_apert(KeepInOrder):
	'''
...
class efieldstruct_arrayreflectometry_radifield_efieldObj(KeepInOrder):
	'''
...
class grid2dstructurereggrid(KeepInOrder):
	'''
...
class launchsignalstructurelaunchsignal(KeepInOrder):
	'''
