...
class polarimetrystructurepolarimetry(KeepInOrder):
	'''
...
class setupstructuremsediag_setup_polarimetry(KeepInOrder):
	'''
...
class rzgammastructurerzphidrdzdphi1D(KeepInOrder):
	'''
...
class spectralstructurespectral(KeepInOrder):
	'''
...
class emissivitystructuremsediag_emissivity(KeepInOrder):
	'''
...
class emiss_chordstruct_arraymsediag_emiss_chordObj(KeepInOrder):
	'''
...
class setupstructurerzphi1D(KeepInOrder):
	'''
...
class polarizationstruct_arraymsediag_polarizationObj(KeepInOrder):
	'''
...
class radiancestructuremsediag_radiance(KeepInOrder):
	'''
...
class wavelengthstructureexp1D(KeepInOrder):
	'''
...
class radia_chordstruct_arraymsediag_radia_chordObj(KeepInOrder):
	'''
...
class setupstructuremsediag_setup(KeepInOrder):
	'''
...
class pivot_pointstructurerzphi0D(KeepInOrder):
	'''
...
class second_pointstructurerzphi0D(KeepInOrder):
	'''
...
class stokesstruct_arraymsediag_stokesObj(KeepInOrder):
	'''
...
class totradiancestructureexp1D(KeepInOrder):
	'''
