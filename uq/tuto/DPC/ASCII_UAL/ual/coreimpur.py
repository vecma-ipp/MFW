...
class impuritystruct_arrayimpurity_typeObj(KeepInOrder):
	'''
...
class source_termstructuresourceimp(KeepInOrder):
	'''
...
class boundarystructureboundaryimp(KeepInOrder):
	'''
...
class transp_coefstructurecoretransimp(KeepInOrder):
	'''
...
class fluxstructurefluximp(KeepInOrder):
	'''
...
class diagnosticstructurecoreimpurediag_type(KeepInOrder):
	'''
...
class radiationstructurecoreimpurediag_radiation(KeepInOrder):
	'''
...
class line_radstructurecoreimpurediagprof_type(KeepInOrder):
	'''
...
class brem_radrecstructurecoreimpurediagprof_type(KeepInOrder):
	'''
...
class sumstructurecoreimpurediagprof_type(KeepInOrder):
	'''
...
class energystructurecoreimpurediag_energy(KeepInOrder):
	'''
...
class ionizationstructurecoreimpurediagprof_type(KeepInOrder):
	'''
...
class recombinstructurecoreimpurediagprof_type(KeepInOrder):
	'''
...
class diagnosticsumstructurecoreimpurediag_sum(KeepInOrder):
	'''
...
class radiationstructurecoreimpurdiag_sum_radiation(KeepInOrder):
	'''
...
class line_radstructurecoreimpurediagsum_type(KeepInOrder):
	'''
...
class brem_radrecstructurecoreimpurediagsum_type(KeepInOrder):
	'''
...
class sumstructurecoreimpurediagsum_type(KeepInOrder):
	'''
...
class energystructurecoreimpurediag_sum_energy(KeepInOrder):
	'''
...
class ionizationstructurecoreimpurediagsum_type(KeepInOrder):
	'''
...
class recombinstructurecoreimpurediagsum_type(KeepInOrder):
	'''
