...
class lithiumdiag(KeepInOrder):
	...
	- setup : class setupstructurelithsetup
	   diagnostic setup information
	- measure : class measurestructurelithmeasure
	   Measured values
...
class lithiumdiagArray:
	'''
	class lithiumdiagArray
	Lithium Beam Diagnostic; Time-dependent CPO

	Attributes:
	- array : list of lithiumdiag
	...
	def __str__(self, depth=0):
		space = depth*'\t'
		ret = space + 'class lithiumdiagArray nb_cpos=%d\n' %(len(self.array))
		for i in range(len(self.array)):
			ret = ret + space + 'lithiumdiag cpos=%d\n' %(i) + self.array[i].__str__(depth+1)
		return ret
...
class setupstructurelithsetup(KeepInOrder):
	'''
	class setupstructurelithsetup
	diagnostic setup information

	Attributes:
	- position : class positionstructurerzphi1D
	   Position of the measurement. Vector (nchannels)
	'''
	...
	def __str__(self, depth=0):
		space = depth*'\t'
		ret = space + 'class setupstructurelithsetup\n'
	...
	def putSlice(self, path, cpopath):
		if (verb()):
			print ('field '+self.base_path+' of type setupstructurelithsetup, run function putSlice') 
		if cpopath=='':
			cpopath = self.base_path + '/'
		else:
			cpopath = cpopath + self.base_path + '/' 
	...
	def replaceLastSlice(self, path, cpopath):
		if (verb()):
			print ('field '+self.base_path+' of type setupstructurelithsetup, run function replaceLastSlice') 
		if cpopath=='':
			cpopath = self.base_path + '/'
		else:
			cpopath = cpopath + self.base_path + '/' 
	...
	def putNonTimed(self, path, cpopath):
		if (verb()):
			print ('field '+self.base_path+' of type setupstructurelithsetup, run function putNonTimed') 
		if cpopath=='':
			cpopath = self.base_path + '/'
		else:
			cpopath = cpopath + self.base_path + '/' 
	...
	def getSlice(self, path, cpopath, inTime, interpolMode):
		if (verb()):
			print ('field '+self.base_path+' of type setupstructurelithsetup, run function getSlice') 
		if cpopath=='':
			cpopath = self.base_path + '/'
		else:
			cpopath = cpopath + self.base_path + '/' 
	...
	def build_non_resampled_data(self, path, cpopath, nbslice):
		if (verb()):
			print ('field '+self.base_path+' of type setupstructurelithsetup, run function build_non_resampled_data') 
		if cpopath=='':
			cpopath = self.base_path + '/'
		else:
			cpopath = cpopath + self.base_path + '/' 
		...
		if nbslice > 0:
			...
			for i in range(nbslice):
				slice = setupstructurelithsetup(self.base_path)
				slice.setExpIdx(self.idx)
	...
	def putTimedElt(self, path, cpopath, i, obj):
		if (verb()):
			print ('object of type setupstructurelithsetupObj, run function putTimedElt') 
		cpopath = cpopath + '/' 
		return obj

	def getTimedElt(self, path, cpopath, i, obj):
		if (verb()):
			print ('object of type setupstructurelithsetupObj, run function getTimedElt') 
		cpopath = cpopath + '/' 

	def putNonTimedElt(self, path, cpopath, i, obj):
		if (verb()):
			print ('object of type setupstructurelithsetupObj, run function putNonTimedElt') 
		cpopath = cpopath + '/' 
	...
	def getNonTimedElt(self, path, cpopath, i, obj):
		if (verb()):
			print ('object of type setupstructurelithsetupObj, run function getNonTimedElt') 
		cpopath = cpopath + '/' 
...
class measurestructurelithmeasure(KeepInOrder):
	'''
	class measurestructurelithmeasure
	Measured values

	Attributes:
	- ne : class nestructureexp1D
	   Electron density [m^-3]. Vector (nchannels)
	'''
	...
	def __str__(self, depth=0):
		space = depth*'\t'
		ret = space + 'class measurestructurelithmeasure\n'
	...
	def putSlice(self, path, cpopath):
		if (verb()):
			print ('field '+self.base_path+' of type measurestructurelithmeasure, run function putSlice') 
		if cpopath=='':
			cpopath = self.base_path + '/'
		else:
			cpopath = cpopath + self.base_path + '/' 
	...
	def replaceLastSlice(self, path, cpopath):
		if (verb()):
			print ('field '+self.base_path+' of type measurestructurelithmeasure, run function replaceLastSlice') 
		if cpopath=='':
			cpopath = self.base_path + '/'
		else:
			cpopath = cpopath + self.base_path + '/' 
	...
	def putNonTimed(self, path, cpopath):
		if (verb()):
			print ('field '+self.base_path+' of type measurestructurelithmeasure, run function putNonTimed') 
		if cpopath=='':
			cpopath = self.base_path + '/'
		else:
			cpopath = cpopath + self.base_path + '/' 
	...
	def getSlice(self, path, cpopath, inTime, interpolMode):
		if (verb()):
			print ('field '+self.base_path+' of type measurestructurelithmeasure, run function getSlice') 
		if cpopath=='':
			cpopath = self.base_path + '/'
		else:
			cpopath = cpopath + self.base_path + '/' 
	...
	def build_non_resampled_data(self, path, cpopath, nbslice):
		if (verb()):
			print ('field '+self.base_path+' of type measurestructurelithmeasure, run function build_non_resampled_data') 
		if cpopath=='':
			cpopath = self.base_path + '/'
		else:
			cpopath = cpopath + self.base_path + '/' 
		...
		if nbslice > 0:
			...
			for i in range(nbslice):
				slice = measurestructurelithmeasure(self.base_path)
				slice.setExpIdx(self.idx)
				slice.ne = neList[i]
				list.append(slice)
		else:
	...
	def putTimedElt(self, path, cpopath, i, obj):
		if (verb()):
			print ('object of type measurestructurelithmeasureObj, run function putTimedElt') 
		cpopath = cpopath + '/' 
	...
	def getTimedElt(self, path, cpopath, i, obj):
		if (verb()):
			print ('object of type measurestructurelithmeasureObj, run function getTimedElt') 
		cpopath = cpopath + '/' 
		self.ne.getTimedElt(path, cpopath + 'ne', i, obj)

	def putNonTimedElt(self, path, cpopath, i, obj):
		if (verb()):
			print ('object of type measurestructurelithmeasureObj, run function putNonTimedElt') 
		cpopath = cpopath + '/' 
	...
	def getNonTimedElt(self, path, cpopath, i, obj):
		if (verb()):
			print ('object of type measurestructurelithmeasureObj, run function getNonTimedElt') 
		cpopath = cpopath + '/' 
