...
class nbi_unitstruct_arraynbi_unitObj(KeepInOrder):
	'''
...
class inj_specstructureinj_spec(KeepInOrder):
	'''
...
class pow_unitstructureexp0D(KeepInOrder):
	'''
...
class inj_eng_unitstructureexp0D(KeepInOrder):
	'''
...
class beamcurrfracstructureexp1D(KeepInOrder):
	'''
...
class beampowrfracstructureexp1D(KeepInOrder):
	'''
...
class beamletgroupstruct_arraybeamletgroupObj(KeepInOrder):
	'''
...
class positionstructurerzphi0D(KeepInOrder):
	'''
...
class focussingstructurefocussing(KeepInOrder):
	'''
...
class divergencestructuredivergence(KeepInOrder):
	'''
...
class beamletsstructurebeamlets(KeepInOrder):
	'''
...
class wallstructurenbi_nbi_unit_wall(KeepInOrder):
	'''
...
class surfacestructurenbi_nbi_unit_wall_surface(KeepInOrder):
	'''
...
class trianglestruct_arraytrianglexyzObj(KeepInOrder):
	'''
...
class point1structurexyz0D(KeepInOrder):
	'''
...
class point2structurexyz0D(KeepInOrder):
	'''
...
class point3structurexyz0D(KeepInOrder):
	'''
...
class rectanglestruct_arrayrectanglexyzObj(KeepInOrder):
	'''
...
class point01structurexyz0D(KeepInOrder):
	'''
...
class point11structurexyz0D(KeepInOrder):
	'''
...
class point10structurexyz0D(KeepInOrder):
	'''
...
class collimatorstruct_arrayflat_polygonObj(KeepInOrder):
	'''
...
class originstructurexyz0D(KeepInOrder):
	'''
...
class basis1structurexyz0D(KeepInOrder):
	'''
...
class basis2structurexyz0D(KeepInOrder):
	'''
