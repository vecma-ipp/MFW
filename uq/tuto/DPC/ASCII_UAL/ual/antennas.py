...
class antenna_ecstruct_arrayantenna_ecObj(KeepInOrder):
	'''
...
class powerstructureexp0D(KeepInOrder):
	'''
...
class launchanglesstructurelaunchangles(KeepInOrder):
	'''
...
class beamstructurerfbeam(KeepInOrder):
	'''
...
class spotstructurespot(KeepInOrder):
	'''
...
class phaseellipsestructurephaseellipse(KeepInOrder):
	'''
...
class antenna_icstruct_arrayantenna_icObj(KeepInOrder):
	'''
...
class frequencystructureexp0D(KeepInOrder):
	'''
...
class setupstructureantennaic_setup(KeepInOrder):
	'''
...
class strapsstruct_arraystrapsObj(KeepInOrder):
	'''
...
class currentstructureexp0D(KeepInOrder):
	'''
...
class phasestructureexp0D(KeepInOrder):
	'''
...
class coord_strapstructurerz1D(KeepInOrder):
	'''
...
class currentstructurecurrent(KeepInOrder):
	'''
...
class spectrumstructureexp1D(KeepInOrder):
	'''
...
class rz_referencestructurerz0D(KeepInOrder):
	'''
...
class antenna_lhstruct_arrayantenna_lhObj(KeepInOrder):
	'''
...
class setupstructureantennalh_setup(KeepInOrder):
	'''
...
class modulesstructuremodules(KeepInOrder):
	'''
...
class amplitudestructureexp1D(KeepInOrder):
	'''
...
class phasestructureexp1D(KeepInOrder):
	'''
...
class waveguidesstructurewaveguides(KeepInOrder):
	'''
...
class plasmaedgestructureplasmaedge(KeepInOrder):
	'''
