...
class desc_tfcoilsstructuretf_desc_tfcoils(KeepInOrder):
	'''
...
class circularcoilstructurecircularcoil(KeepInOrder):
	'''
...
class centrestructurerz0D(KeepInOrder):
	'''
...
class planecoilstructureplanecoil(KeepInOrder):
	'''
...
class coordinatesstructurerz1D(KeepInOrder):
	'''
...
class inboardstructuretf_structure(KeepInOrder):
	'''
...
class outboardstructuretf_structure(KeepInOrder):
	'''
...
class bvac_rstructureexp0D(KeepInOrder):
	'''
