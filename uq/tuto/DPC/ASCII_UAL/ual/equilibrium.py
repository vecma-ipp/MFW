...
class eqconstraintstructureeqconstraint(KeepInOrder):
	'''
...
class bpolstructureeqmes1D(KeepInOrder):
	'''
...
class bvac_rstructureeqmes0D(KeepInOrder):
	'''
...
class diamagfluxstructureeqmes0D(KeepInOrder):
	'''
...
class faradaystructureeqmes1D(KeepInOrder):
	'''
...
class fluxstructureeqmes1D(KeepInOrder):
	'''
...
class i_plasmastructureeqmes0D(KeepInOrder):
	'''
...
class isofluxstructureisoflux(KeepInOrder):
	'''
...
class jsurfstructureeqmes1D(KeepInOrder):
	'''
...
class magnet_ironstructuremagnet_iron(KeepInOrder):
	'''
...
class mrstructureeqmes1D(KeepInOrder):
	'''
...
class mzstructureeqmes1D(KeepInOrder):
	'''
...
class msestructureeqmes1D(KeepInOrder):
	'''
...
class nestructureeqmes1D(KeepInOrder):
	'''
...
class pfcurrentstructureeqmes1D(KeepInOrder):
	'''
...
class pressurestructureeqmes1D(KeepInOrder):
	'''
...
class xptsstructurexpts(KeepInOrder):
	'''
...
class eqgeometrystructureeqgeometry(KeepInOrder):
	'''
...
class boundarystruct_arrayrz1DexpObj(KeepInOrder):
	'''
...
class xptsstruct_arrayrz1DexpObj(KeepInOrder):
	'''
...
class left_low_ststructurerz0D(KeepInOrder):
	'''
...
class right_low_ststructurerz0D(KeepInOrder):
	'''
...
class left_up_ststructurerz0D(KeepInOrder):
	'''
...
class right_up_ststructurerz0D(KeepInOrder):
	'''
...
class active_limitstructurerz0D(KeepInOrder):
	'''
...
class flushstructureflush(KeepInOrder):
	'''
...
class global_paramstructureglobal_param(KeepInOrder):
	'''
...
class mag_axisstructuremag_axis(KeepInOrder):
	'''
...
class positionstructurerz0D(KeepInOrder):
	'''
...
class profiles_1dstructureprofiles_1d(KeepInOrder):
	'''
...
class profiles_2dstruct_arrayequilibrium_profiles_2dObj(KeepInOrder):
	'''
...
class gridstructureequilibrium_profiles2d_grid(KeepInOrder):
	'''
...
class coord_sysstructurecoord_sys(KeepInOrder):
	'''
...
class gridstructurereggrid(KeepInOrder):
	'''
...
class positionstructurerz2D(KeepInOrder):
	'''
