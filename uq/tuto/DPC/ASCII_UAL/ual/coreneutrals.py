...
class coreneutrals(KeepInOrder):
	'''
	class coreneutrals
...
class neutcompostructurecomposition_neutrals(KeepInOrder):
	'''
...
class atomliststruct_arraycoreneutrals_atomlistObj(KeepInOrder):
	'''
...
class ionimptypestructureidentifier(KeepInOrder):
	'''
...
class neutralstruct_arraycomposition_neutralscompObj(KeepInOrder):
	'''
...
class profilesstruct_arrayneutral_complex_typeObj(KeepInOrder):
	'''
...
class neutraltypestruct_arraycoreneutrals_neutraltypeObj(KeepInOrder):
	'''
...
class n0structurecorefieldneutral(KeepInOrder):
	'''
...
class boundarystructureboundary_neutrals(KeepInOrder):
	'''
...
class t0structurecorefieldneutrale(KeepInOrder):
	'''
...
class v0structurecorefieldneutralv0(KeepInOrder):
	'''
...
class toroidalstructurecorefieldneutralv(KeepInOrder):
	'''
...
class poloidalstructurecorefieldneutralv(KeepInOrder):
	'''
...
class radialstructurecorefieldneutralv(KeepInOrder):
	'''
...
class ioncoeffstruct_arraycoefficients_neutralsObj(KeepInOrder):
	'''
...
class recyclingstructurerecycling_neutrals(KeepInOrder):
	'''
...
class sputteringstructuresputtering_neutrals(KeepInOrder):
	'''
...
class impcoeffstruct_arrayimpcoeffObj(KeepInOrder):
	'''
...
class chargestatestruct_arraycoefficients_neutralsObj(KeepInOrder):
	'''
