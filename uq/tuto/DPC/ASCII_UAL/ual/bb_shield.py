...
class limitsstructurelimits(KeepInOrder):
	'''
...
class geomstructuregeom(KeepInOrder):
	'''
...
class neut_resultsstructureneut_results(KeepInOrder):
	'''
...
class shieldstructureshield(KeepInOrder):
	'''
...
class inboardstructureshield_specs(KeepInOrder):
	'''
...
class outboardstructureshield_specs(KeepInOrder):
	'''
...
class bbstructurebb(KeepInOrder):
	'''
	class bbstructurebb
	Breeding blanket
...
class neutro_resulstructureneutro_resul(KeepInOrder):
	'''
...
class inboardstructurebb_specs(KeepInOrder):
	'''
...
class dimensionstructurebb_dimension(KeepInOrder):
	'''
...
class outboardstructurebb_specs(KeepInOrder):
	'''
...
class hcllstructurehcll(KeepInOrder):
	'''
...
class mat_limstructuremat_lim(KeepInOrder):
	'''
...
class hcll_bbstructurehcll_bb(KeepInOrder):
	'''
...
class reactstructurereact(KeepInOrder):
	'''
...
class inboardstructurehcllbb_specs(KeepInOrder):
	'''
...
class mod_geomstructurebb_geometry(KeepInOrder):
	'''
...
class top_cap_dimstructurebb_dimension(KeepInOrder):
	'''
...
class bot_cap_dimstructurebb_dimension(KeepInOrder):
	'''
...
class mod_neutrstructuremode_neutr(KeepInOrder):
	'''
...
class pow_exchangestructurepower_exchange(KeepInOrder):
	'''
...
class mod_thermstructuremode_therm(KeepInOrder):
	'''
...
class mod_th_hydstructuremode_th_hyd(KeepInOrder):
	'''
...
class mod_mechstructuremode_mech(KeepInOrder):
	'''
...
class mod_lipbstructuremode_lipb(KeepInOrder):
	'''
...
class mod_tritiumstructuremode_tritium(KeepInOrder):
	'''
...
class outboardstructurehcllbb_specs(KeepInOrder):
	'''
