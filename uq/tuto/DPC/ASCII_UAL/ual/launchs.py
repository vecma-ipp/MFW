...
class spectrumstructurespectrum(KeepInOrder):
	'''
...
class phi_thetastructurelaunchs_phi_theta(KeepInOrder):
	'''
...
class parallelstructurelaunchs_parallel(KeepInOrder):
	'''
...
class beamstructurelaunchs_rfbeam(KeepInOrder):
	'''
...
class spotstructurelaunchs_rfbeam_spot(KeepInOrder):
	'''
...
class phaseellipsestructurelaunchs_rfbeam_phaseellipse(KeepInOrder):
	'''
