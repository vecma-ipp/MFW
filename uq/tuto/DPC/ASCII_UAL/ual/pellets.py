...
class pelletstruct_arraypelletObj(KeepInOrder):
	'''
...
class shapestructurepellet_shape(KeepInOrder):
	'''
...
class elementsstructurepellet_elements(KeepInOrder):
	'''
...
class geometrystructurepellet_geometry(KeepInOrder):
	'''
...
class anglesstructurepellet_angles(KeepInOrder):
	'''
...
class pathprofilesstructurepellet_pathprofiles(KeepInOrder):
	'''
...
class depositionstructurepellet_deposition(KeepInOrder):
	'''
...
class impuritystruct_arraypellet_impurityObj(KeepInOrder):
	'''
