...
campaign_name = "UQ_GEM0_QMC_1ft_"
...
os.system("cp " + xml_dir + "/gem0.xml " + common_dir + "/gem0.xml")
os.system("cp " + xml_dir + "/gem0.xsd " + common_dir + "/gem0.xsd")
...
my_sampler = uq.sampling.QMCSampler(vary=vary, n_mc_samples=120)   #, count=0, n_samples=10**3)
