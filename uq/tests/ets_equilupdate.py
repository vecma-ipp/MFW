...
exec_code = "ets_equilupdate_test"

# Define the uncertain parameters:
# boudary conditions and heating Sources
input_params_bc = {
    "te.boundary.value": {
        "dist": "Normal",
        "err": 0.2,
...
output_columns = ["profiles_1d.pressure", "profiles_1d.q",
        "profiles_1d.jparallel", "profiles_1d.jphi", "profiles_1d.gm1",
        "profiles_1d.gm2", "profiles_1d.gm3", "profiles_1d.gm4",
        "profiles_1d.gm5", "profiles_1d.gm6", "profiles_1d.gm7",
        "profiles_1d.gm8", "profiles_1d.gm8"]
