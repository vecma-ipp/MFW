...
obj_dir = os.path.abspath("../standalone/mpi_test")
exec_code = "main"
...
qcgpjexec.print_resources_info()
...
qcgpjexec.add_task(Task(
    ...
    application=mpi_instance + " 16 " + exec_path
))
