...
#SBATCH --job-name=r134_spread_GEM128_AUG_28906_4_Series_unified-test		# job name
#SBATCH --err=test-%j.err			# std-error file
#SBATCH --out=test-%j.out			# std-output file
#SBATCH --account=FUA32_MCP-SB 			# account number
...
source /marconi_work/FUA32_MCP-SB/MUSCLE/compat-1.1/etc/muscle.profile
