...
TAU = 0.01
EVOLVE_EQUIL = true
FLUX_TO_DV   = true#false
NOISE        = false
CONST_TURB   = false
SYS = "MARCONI"

INIT_K   = "CONTINUE"
EQUI_K   = "CHEASE"#"BDSEQ"#"CHEASE"
TURB_K   = "GEM"#"BOHMGB"#"GEM"
TRANSP_K = "ETS"
...
#=====equil=======================================
if EVOLVE_EQUIL
  equil.couple(transp, {'equilibrium_out' => 'equilibrium_in'})
end
...
dupEquil.couple(equil, 'equilibrium_in')
