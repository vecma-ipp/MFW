...
'''
UQ test of ETS code using UQP2.
Uncertainties in:
...
stats = results['statistical_moments']['P']
pctl = results['percentiles']['P']
sob_1st = results['sobols_first']['P']
sob_tot = results['sobols_total']['P']
#
