...
contains
  ...
  ! n_elements = n
  ! degree = k
  subroutine approximate_curve(x, y, n, k, method, t, cx, cy)
    implicit none
    ...
    real(8), dimension(:), intent(out) :: cy
    ...
    ! get control points 
    call splrep(u, x, w, t, k, cx)
    call splrep(u, y, w, t, k, cy)
