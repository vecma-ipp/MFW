...
type type_global_param  !    0d output parameters
  ...
  real(DP)  :: bphi_sign=-9.0D40       ! /global_param/bphi_sign - sign of toroidal magnetic field; Scalar +1 or -1
  real(DP)  :: i_plasma=-9.0D40       ! /global_param/i_plasma - total toroidal plasma current [A]; Time-dependent; Scalar
  real(DP)  :: ip_sign=-9.0D40       ! /global_param/i_pl_sign - sign of total toroidal plasma current; Scalar +1 or -1
