...
type ids_wall_global_quantitites_ion  !    Simple 0D description of plasma-wall interaction, related to a given ion species
  type (ids_plasma_composition_neutral_element),pointer :: element(:) => null()  ! /element(i) - List of elements forming the atom or molecule
  character(len=132), dimension(:), pointer ::label => null()       ! /label - String identifying the species (e.g. H, D, CD4, ...)
  real(DP),pointer  :: pumping_speed(:) => null()     ! /pumping_speed - Pumping speed of that species
...
type ids_wall_global_quantitites  !    Simple 0D description of plasma-wall interaction
  type (ids_wall_global_quantitites_ion),pointer :: ion(:) => null()  ! /ion(i) - Quantities related to the various plasma ion/neutral species (in this structure charge states are no
