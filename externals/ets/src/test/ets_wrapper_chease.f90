...
!> \author D. Coster
!>
!> \version "$Id: ets_wrapper_chease.f90 1763 2016-06-22 15:41:53Z dpc $"
! + + + + + + + + + + + + + + + + + + + + + + + + + + + +  
module ets_wrapper_chease
  ...
  subroutine chease_wrapper(euitm_equilibrium_in, euitm_equilibrium_out)
    ...
    if(associated(euitm_equilibrium_in(1)%profiles_1d%jparallel)) then
       ...
       if(maxabs .EQ. 0.0_R8) then
          write(*,*) 'chease_wrapper copied jparallel to jphi [ERROR]'
    ...
    if(associated(euitm_equilibrium_in(1)%profiles_1d%psi)) then
       write(*,*) 'chease_wrapper set psi_bound and psi_ax [ERROR]'
...
! end of the experiment
    ...
    if(.not.associated(euitm_equilibrium_out(1)%profiles_1d%jparallel)) then
       write(*,*) 'chease_wrapper copied jphi to jparallel [ERROR]'
  ...
  end subroutine chease_wrapper

end module ets_wrapper_chease
