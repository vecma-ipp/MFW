program bdseq_kernelB
  ...
  do it = init_step,target_step
...
#endif
     print *,'BDSEQ_B kernel: receive data'
     recv_size = BUF_SIZE
     ...
     call c_getMillis(tt0)
#endif
     print *,'BDSEQ_B kernel: call native routine'
     call bdseq2buf(equil_in, equil_out)
#ifdef PERF
     call c_getMillis(tt1)
     twrap = tt1 - tt0
#endif
  ...
  print *,'BDSEQ_B kernel: end of loop'
